...
<!--/.Carousel Wrapper-->
      ...
      <section>
          <div >
        <h2><strong>Completed Water Supply ,Borehole Drilling,Dam Construction And Irrigation Works </strong></h2>
        <hr>
        <h3>Client</h3>
        <h4>Timau Farm </h4>
        <h3>Project</h3>
        <h4>
            ...
            Installation of a drip irrigation system for a maximum of 112 Hectares from 5 No. Boreholes and maintenance services.
          ...
          <div >
            ...
            <h4>Greenlands Agro-Producers Ltd </h4>
            <hr>
            <h3>Project</h3>
            <h4>Upgrading to Bitumen Standards of Marigath-Karandi,Ol-Ngarua-MuhotetuJnct 77 & Muhotetu sipili Road-RWC 269 .  Networks Covering 6500 Acres of land; 25 km various G.I pipes sizes ranging from 50 – 150mm dia. & 4 No. Borehole Drilling and Equipping (150-230m) deep at Pioneer Farm, Nanyuki and maintenance services. </h4>
              </div>
              <hr>
              <div >
                <h2><strong>Client</strong></h2>
                <h4>Lake Victoria South Water Services Board</h4>
                <hr>
                <h3>Project</h3>
                <h4>Drilling of 4 No Boreholes, 120m deep each 
                    Tender – Kokelo, Apondo C, Mariwa & Nyota Express CBOs.</h4>
